                ...
                <form  action="" className="space-y-7">
                    <div className="space-y-2 text-sm">
                        <div className='relative'>
                            <input type="email" name="email" id="email" placeholder="OTP" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring text-end" />
